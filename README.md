...
- <b>FASE7</b>: **Launcher central** (inicia qualquer fase por um único menu) e o
  **serviço de mensageria AWS** em `FASE7/AWS_Mensageria` (Amazon SNS com alertas e ações corretivas).
...
[FASE7/AWS_Mensageria/README.md](FASE7/AWS_Mensageria/README.md)

<p align="center">
  <img src="FASE7/AWS_Mensageria/assets/awsgeral.jpeg" alt="Caixa de entrada com os alertas do Amazon SNS" width="45%">
  <img src="FASE7/AWS_Mensageria/assets/aws2.jpeg" alt="Exemplo de alerta por e-mail (Amazon SNS)" width="50%">
</p>
